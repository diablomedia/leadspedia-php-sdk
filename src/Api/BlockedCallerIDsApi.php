...
/**
 * BlockedCallerIDsApi Class Doc Comment
 *
 * @category Class
 * @package  Leadspedia
 * @author   OpenAPI Generator team
...
class BlockedCallerIDsApi
{
    ...
    /**
     * Operation blockedCallerIDsadddo
     *
     * Add Caller ID
     *
     ...
     */
    public function blockedCallerIDsadddo($phoneNumber, $note = null)
    {
        list($response) = $this->blockedCallerIDsadddoWithHttpInfo($phoneNumber, $note);
        return $response;
    }

    /**
     * Operation blockedCallerIDsadddoWithHttpInfo
     *
     * Add Caller ID
     *
     ...
     */
    public function blockedCallerIDsadddoWithHttpInfo($phoneNumber, $note = null)
    {
        $request = $this->blockedCallerIDsadddoRequest($phoneNumber, $note);
    ...
    /**
     * Operation blockedCallerIDsadddoAsync
     *
     * Add Caller ID
     *
     * @param  string $phoneNumber (required)
     ...
     */
    public function blockedCallerIDsadddoAsync($phoneNumber, $note = null)
    {
        return $this->blockedCallerIDsadddoAsyncWithHttpInfo($phoneNumber, $note)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation blockedCallerIDsadddoAsyncWithHttpInfo
     *
     * Add Caller ID
     *
     * @param  string $phoneNumber (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blockedCallerIDsadddoAsyncWithHttpInfo($phoneNumber, $note = null)
    {
        $returnType = '\Leadspedia\Model\Affiliatescreatedo200Response';
        $request = $this->blockedCallerIDsadddoRequest($phoneNumber, $note);
    ...
    /**
     * Create request for operation 'blockedCallerIDsadddo'
     *
     * @param  string $phoneNumber (required)
     * @param  string $note (optional)
     *
     ...
     */
    public function blockedCallerIDsadddoRequest($phoneNumber, $note = null)
    {
        // verify the required parameter 'phoneNumber' is set
        if ($phoneNumber === null || (is_array($phoneNumber) && count($phoneNumber) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $phoneNumber when calling blockedCallerIDsadddo'
            );
        }

        $resourcePath = '/blockedCallerIDs/add.do';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
