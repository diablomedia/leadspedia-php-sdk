...
class AdvertisersContactsApi
{
     ...
     */
    public function advertisersContactschangePassworddoRequest($contactID, $oldPassword, $newPassword)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function advertisersContactschangeStatusdoRequest($contactID, $status)
    {
        // verify the required parameter 'contactID' is set
        if ($contactID === null || (is_array($contactID) && count($contactID) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function advertisersContactscreatedoRequest($advertiserID, $firstName, $lastName, $emailAddress, $password, $jobTitle = null, $phoneNumber = null, $portalAccess = 'No', $status = 'Active')
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function advertisersContactsdeletedoRequest($contactID)
    {
        // verify the required parameter 'contactID' is set
        if ($contactID === null || (is_array($contactID) && count($contactID) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function advertisersContactsgetAlldoRequest($contactID = null, $advertiserID = null, $portalAccess = null, $start = 0, $limit = 100)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function advertisersContactsgetInfodoRequest($contactID)
    {
        // verify the required parameter 'contactID' is set
        if ($contactID === null || (is_array($contactID) && count($contactID) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function advertisersContactsupdatedoRequest($contactID, $firstName = null, $lastName = null, $jobTitle = null, $emailAddress = null, $phoneNumber = null, $officePhone = null, $ext = null, $portalAccess = null, $role = null, $massEmail = null, $permissionAccount = null, $permissionBilling = null, $permissionOffers = null, $permissionReports = null, $permissionUsers = null)
    {
        // verify the required parameter 'contactID' is set
        if ($contactID === null || (is_array($contactID) && count($contactID) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function advertisersContactsverifyCredentialsdoRequest($emailAddress, $password)
    {
        // verify the required parameter 'emailAddress' is set
        if ($emailAddress === null || (is_array($emailAddress) && count($emailAddress) === 0)) {
            throw new \InvalidArgumentException(
