...
class OffersApi
{
    ...
    protected function offerschangeAutoApprovaldoRequest($offerID, $autoApprove)
    {
        ...
        if (is_array($autoApprove)) {
            $autoApprove = ObjectSerializer::serializeCollection($autoApprove, '', true);
        }
        if ($autoApprove !== null) {
            $queryParams['autoApprove'] = $autoApprove;
        }
    ...
    protected function offerschangeFeatureListingdoRequest($offerID, $feature)
    {
        ...
        // query params
        if (is_array($feature)) {
            $feature = ObjectSerializer::serializeCollection($feature, '', true);
        }
        if ($feature !== null) {
    ...
    protected function offersrenamedoRequest($offerID, $offerName)
    {
        ...
        if (is_array($offerName)) {
            $offerName = ObjectSerializer::serializeCollection($offerName, '', true);
        }
        if ($offerName !== null) {
    ...
    protected function offersupdateBasicInfodoRequest($offerID, $offerName = null, $notes = null, $alternativeID = null, $previewURL = null, $offerDescription = null, $testingInstructions = null, $offerRestrictions = null)
    {
        ...
        if (is_array($previewURL)) {
            $previewURL = ObjectSerializer::serializeCollection($previewURL, '', true);
        }
        if ($previewURL !== null) {
            $queryParams['previewURL'] = $previewURL;
        }
        // query params
        if (is_array($offerDescription)) {
            $offerDescription = ObjectSerializer::serializeCollection($offerDescription, '', true);
        }
        if ($offerDescription !== null) {
            $queryParams['offerDescription'] = $offerDescription;
        }
        // query params
        if (is_array($testingInstructions)) {
            $testingInstructions = ObjectSerializer::serializeCollection($testingInstructions, '', true);
        }
        if ($testingInstructions !== null) {
            $queryParams['testingInstructions'] = $testingInstructions;
        }
        // query params
        if (is_array($offerRestrictions)) {
            $offerRestrictions = ObjectSerializer::serializeCollection($offerRestrictions, '', true);
        }
        if ($offerRestrictions !== null) {
            $queryParams['offerRestrictions'] = $offerRestrictions;
        }
    ...
    protected function offersupdateEmailSettingsdoRequest($offerID, $testEmail = null, $allowedEmails = null, $allowedSubjects = null, $emailInstructions = null)
    {
        ...
        if (is_array($testEmail)) {
            $testEmail = ObjectSerializer::serializeCollection($testEmail, '', true);
        }
        if ($testEmail !== null) {
            $queryParams['testEmail'] = $testEmail;
        }
        // query params
        if (is_array($allowedEmails)) {
            $allowedEmails = ObjectSerializer::serializeCollection($allowedEmails, '', true);
        }
        if ($allowedEmails !== null) {
            $queryParams['allowedEmails'] = $allowedEmails;
        }
        // query params
        if (is_array($allowedSubjects)) {
            $allowedSubjects = ObjectSerializer::serializeCollection($allowedSubjects, '', true);
        }
        if ($allowedSubjects !== null) {
            $queryParams['allowedSubjects'] = $allowedSubjects;
        }
        // query params
        if (is_array($emailInstructions)) {
            $emailInstructions = ObjectSerializer::serializeCollection($emailInstructions, '', true);
        }
        if ($emailInstructions !== null) {
            $queryParams['emailInstructions'] = $emailInstructions;
        }
    ...
    protected function offersupdateTermsSettingsdoRequest($offerID, $terms = null, $termsEnabled = null)
    {
        ...
        // query params
        if (is_array($terms)) {
            $terms = ObjectSerializer::serializeCollection($terms, '', true);
        }
        if ($terms !== null) {
            $queryParams['terms'] = $terms;
        }
        // query params
        if (is_array($termsEnabled)) {
            $termsEnabled = ObjectSerializer::serializeCollection($termsEnabled, '', true);
        }
        if ($termsEnabled !== null) {
            $queryParams['termsEnabled'] = $termsEnabled;
        }
