...
class AudioApi
{
     ...
     */
    public function audiodeletedo($audioID): void
    {
        $this->audiodeletedoWithHttpInfo($audioID);
    }
     ...
     */
    public function audiodeletedoWithHttpInfo($audioID)
    {
     ...
     */
    protected function audiodeletedoRequest($audioID)
    {
        // verify the required parameter 'audioID' is set
        if ($audioID === null || (is_array($audioID) && count($audioID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $audioID when calling audiodeletedo'
            );
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function audiogetAlldoRequest($audioID = null, $audioType = null, $start = 0, $limit = 100)
    {
        ...
        // query params
        if (is_array($audioType)) {
            $audioType = ObjectSerializer::serializeCollection($audioType, '', true);
        }
        if ($audioType !== null) {
            $queryParams['audioType'] = $audioType;
        }
        // query params
        if (is_array($start)) {
