...
class LeadDistributionContractsApi
{
    ...
    protected function leadDistributionContractsaddFilterdoRequest($contractID, $fieldID, $operator, $value = null, $date = null, $miles = null)
    {
        ...
        // query params
        if (is_array($fieldID)) {
            $fieldID = ObjectSerializer::serializeCollection($fieldID, '', true);
        }
        if ($fieldID !== null) {
        ...
        if (is_array($operator)) {
            $operator = ObjectSerializer::serializeCollection($operator, '', true);
        }
        if ($operator !== null) {
        ...
        // query params
        if (is_array($miles)) {
            $miles = ObjectSerializer::serializeCollection($miles, '', true);
        }
        if ($miles !== null) {
    ...
    /**
     * Operation leadDistributionContractsadjustCreditdo
     *
     * Adjust Credit
     *
     * @param  int $contractID contractID (required)
    ...
    /**
     * Operation leadDistributionContractsadjustCreditdoWithHttpInfo
     *
     * Adjust Credit
     *
     * @param  int $contractID (required)
    ...
    /**
     * Operation leadDistributionContractsadjustCreditdoAsync
     *
     * Adjust Credit
     *
     * @param  int $contractID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadDistributionContractsadjustCreditdoAsync($contractID, $type, $amount, $charge = 'No', $generateInvoice = 'No', $note = null, $transactionFee = null, $transactionFeePercentage = null, $transactionFeeAmount = null)
    {
        return $this->leadDistributionContractsadjustCreditdoAsyncWithHttpInfo($contractID, $type, $amount, $charge, $generateInvoice, $note, $transactionFee, $transactionFeePercentage, $transactionFeeAmount)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation leadDistributionContractsadjustCreditdoAsyncWithHttpInfo
     *
     * Adjust Credit
     *
     * @param  int $contractID (required)
    ...
    /**
     * Create request for operation 'leadDistributionContractsadjustCreditdo'
     *
     * @param  int $contractID (required)
     * @param  string $type (required)
     * @param  float $amount (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function leadDistributionContractsadjustCreditdoRequest($contractID, $type, $amount, $charge = 'No', $generateInvoice = 'No', $note = null, $transactionFee = null, $transactionFeePercentage = null, $transactionFeeAmount = null)
    {
        // verify the required parameter 'contractID' is set
        if ($contractID === null || (is_array($contractID) && count($contractID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contractID when calling leadDistributionContractsadjustCreditdo'
            );
        }
        // verify the required parameter 'type' is set
        if ($type === null || (is_array($type) && count($type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $type when calling leadDistributionContractsadjustCreditdo'
            );
        }
        // verify the required parameter 'amount' is set
        if ($amount === null || (is_array($amount) && count($amount) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $amount when calling leadDistributionContractsadjustCreditdo'
            );
        }

        $resourcePath = '/leadDistributionContracts/adjustCredit.do';
        $formParams   = [];
        $queryParams  = [];
        $headerParams = [];
        $httpBody     = '';
    ...
    protected function leadDistributionContractsassignEmailDeliveryMethoddoRequest($contractID, $deliveryMethodID, $emailTo)
    {
        ...
        if (is_array($deliveryMethodID)) {
            $deliveryMethodID = ObjectSerializer::serializeCollection($deliveryMethodID, '', true);
        }
        ...
        // query params
        if (is_array($emailTo)) {
            $emailTo = ObjectSerializer::serializeCollection($emailTo, '', true);
        }
        if ($emailTo !== null) {
            $queryParams['email_to'] = $emailTo;
        }
    ...
    protected function leadDistributionContractsassignSMSDeliveryMethoddoRequest($contractID, $deliveryMethodID, $smsTo)
    {
        ...
        // query params
        if (is_array($smsTo)) {
            $smsTo = ObjectSerializer::serializeCollection($smsTo, '', true);
        }
        if ($smsTo !== null) {
            $queryParams['sms_to'] = $smsTo;
        }
    ...
    protected function leadDistributionContractscreateScheduledoRequest($contractID, $cap, $revenueCap, $price, $startTime, $endTime, $type, $monday = null, $tuesday = null, $wednesday = null, $thursday = null, $friday = null, $saturday = null, $sunday = null)
    {
        ...
        // query params
        if (is_array($cap)) {
            $cap = ObjectSerializer::serializeCollection($cap, '', true);
        }
        if ($cap !== null) {
            $queryParams['cap'] = $cap;
        }
        // query params
        if (is_array($revenueCap)) {
            $revenueCap = ObjectSerializer::serializeCollection($revenueCap, '', true);
        }
        if ($revenueCap !== null) {
            $queryParams['revenueCap'] = $revenueCap;
        }
        // query params
        if (is_array($price)) {
        ...
        // query params
        if (is_array($monday)) {
            $monday = ObjectSerializer::serializeCollection($monday, '', true);
        }
        if ($monday !== null) {
            $queryParams['Monday'] = $monday;
        }
        // query params
        if (is_array($tuesday)) {
            $tuesday = ObjectSerializer::serializeCollection($tuesday, '', true);
        }
        if ($tuesday !== null) {
            $queryParams['Tuesday'] = $tuesday;
        }
        // query params
        if (is_array($wednesday)) {
            $wednesday = ObjectSerializer::serializeCollection($wednesday, '', true);
        }
        if ($wednesday !== null) {
            $queryParams['Wednesday'] = $wednesday;
        }
        // query params
        if (is_array($thursday)) {
            $thursday = ObjectSerializer::serializeCollection($thursday, '', true);
        }
        if ($thursday !== null) {
            $queryParams['Thursday'] = $thursday;
        }
        // query params
        if (is_array($friday)) {
            $friday = ObjectSerializer::serializeCollection($friday, '', true);
        }
        if ($friday !== null) {
            $queryParams['Friday'] = $friday;
        }
        // query params
        if (is_array($saturday)) {
            $saturday = ObjectSerializer::serializeCollection($saturday, '', true);
        }
        if ($saturday !== null) {
            $queryParams['Saturday'] = $saturday;
        }
        // query params
        if (is_array($sunday)) {
            $sunday = ObjectSerializer::serializeCollection($sunday, '', true);
        }
        if ($sunday !== null) {
            $queryParams['Sunday'] = $sunday;
        }
    ...
    protected function leadDistributionContractsdeleteDeliveryMethoddoRequest($deliveryMethodsContractID)
    {
        ...
        // query params
        if (is_array($deliveryMethodsContractID)) {
            $deliveryMethodsContractID = ObjectSerializer::serializeCollection($deliveryMethodsContractID, '', true);
        }
        if ($deliveryMethodsContractID !== null) {
            $queryParams['deliveryMethodsContractID'] = $deliveryMethodsContractID;
        }
    ...
    protected function leadDistributionContractsdeleteFilterdoRequest($filterID)
    {
        ...
        if (is_array($filterID)) {
            $filterID = ObjectSerializer::serializeCollection($filterID, '', true);
        }
        if ($filterID !== null) {
    ...
    protected function leadDistributionContractsdeleteScheduledoRequest($deliveryScheduleID)
    {
        ...
        // query params
        if (is_array($deliveryScheduleID)) {
            $deliveryScheduleID = ObjectSerializer::serializeCollection($deliveryScheduleID, '', true);
        }
        if ($deliveryScheduleID !== null) {
            $queryParams['deliveryScheduleID'] = $deliveryScheduleID;
        }
    ...
    protected function leadDistributionContractsupdateDuplicatesSettingsdoRequest($contractID, $enableDuplicateCheck = null, $numberOfDays = null)
    {
        ...
        // query params
        if (is_array($enableDuplicateCheck)) {
            $enableDuplicateCheck = ObjectSerializer::serializeCollection($enableDuplicateCheck, '', true);
        }
        if ($enableDuplicateCheck !== null) {
            $queryParams['enableDuplicateCheck'] = $enableDuplicateCheck;
        }
        // query params
        if (is_array($numberOfDays)) {
            $numberOfDays = ObjectSerializer::serializeCollection($numberOfDays, '', true);
        }
    ...
    protected function leadDistributionContractsupdateLeadsCapdoRequest($contractID, $hourlyLeadsCap = null, $dailyLeadsCap = null, $weeklyLeadsCap = null, $monthlyLeadsCap = null)
    {
        ...
        // query params
        if (is_array($hourlyLeadsCap)) {
            $hourlyLeadsCap = ObjectSerializer::serializeCollection($hourlyLeadsCap, '', true);
        }
        if ($hourlyLeadsCap !== null) {
            $queryParams['hourlyLeadsCap'] = $hourlyLeadsCap;
        }
        // query params
        if (is_array($dailyLeadsCap)) {
            $dailyLeadsCap = ObjectSerializer::serializeCollection($dailyLeadsCap, '', true);
        }
        if ($dailyLeadsCap !== null) {
            $queryParams['dailyLeadsCap'] = $dailyLeadsCap;
        }
        // query params
        if (is_array($weeklyLeadsCap)) {
            $weeklyLeadsCap = ObjectSerializer::serializeCollection($weeklyLeadsCap, '', true);
        }
        if ($weeklyLeadsCap !== null) {
            $queryParams['weeklyLeadsCap'] = $weeklyLeadsCap;
        }
        // query params
        if (is_array($monthlyLeadsCap)) {
            $monthlyLeadsCap = ObjectSerializer::serializeCollection($monthlyLeadsCap, '', true);
        }
        if ($monthlyLeadsCap !== null) {
            $queryParams['monthlyLeadsCap'] = $monthlyLeadsCap;
        }
    ...
    protected function leadDistributionContractsupdateLeadsSettingsdoRequest($contractID, $minimumLeadAge = null, $maximumLeadAge = null, $maximumPostErrors = null, $timeLeadsPosts = null, $allowQueueLeads = null)
    {
        ...
        // query params
        if (is_array($minimumLeadAge)) {
            $minimumLeadAge = ObjectSerializer::serializeCollection($minimumLeadAge, '', true);
        }
        if ($minimumLeadAge !== null) {
            $queryParams['minimumLeadAge'] = $minimumLeadAge;
        }
        // query params
        if (is_array($maximumLeadAge)) {
            $maximumLeadAge = ObjectSerializer::serializeCollection($maximumLeadAge, '', true);
        }
        if ($maximumLeadAge !== null) {
            $queryParams['maximumLeadAge'] = $maximumLeadAge;
        }
        // query params
        if (is_array($maximumPostErrors)) {
            $maximumPostErrors = ObjectSerializer::serializeCollection($maximumPostErrors, '', true);
        }
        if ($maximumPostErrors !== null) {
            $queryParams['maximumPostErrors'] = $maximumPostErrors;
        }
        // query params
        if (is_array($timeLeadsPosts)) {
            $timeLeadsPosts = ObjectSerializer::serializeCollection($timeLeadsPosts, '', true);
        }
        if ($timeLeadsPosts !== null) {
            $queryParams['timeLeadsPosts'] = $timeLeadsPosts;
        }
        // query params
        if (is_array($allowQueueLeads)) {
            $allowQueueLeads = ObjectSerializer::serializeCollection($allowQueueLeads, '', true);
        }
        if ($allowQueueLeads !== null) {
            $queryParams['allowQueueLeads'] = $allowQueueLeads;
        }
    ...
    protected function leadDistributionContractsupdatePortalSettingsdoRequest($contractID, $showStatus = null, $showLeadData = null, $showSchedule = null, $showCaps = null, $showReturnSettings = null, $allowStatusPause = null, $allowUpdateSchedule = null, $allowManageCaps = null)
    {
        ...
        // query params
        if (is_array($showLeadData)) {
            $showLeadData = ObjectSerializer::serializeCollection($showLeadData, '', true);
        }
        if ($showLeadData !== null) {
            $queryParams['showLeadData'] = $showLeadData;
        }
        // query params
    ...
    protected function leadDistributionContractsupdateReturnsSettingsdoRequest($contractID, $allowReturns = null, $autoApproveReturns = null, $replaceReturns = null, $replacementNonReturnable = null)
    {
        ...
        // query params
        if (is_array($replacementNonReturnable)) {
            $replacementNonReturnable = ObjectSerializer::serializeCollection($replacementNonReturnable, '', true);
        }
        if ($replacementNonReturnable !== null) {
            $queryParams['replacementNonReturnable'] = $replacementNonReturnable;
        }
