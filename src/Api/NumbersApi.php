...
class NumbersApi
{
    ...
    {
        list($response) = $this->numbersgetAvailabledoWithHttpInfo($start, $limit);
        return $response;
    }
     ...
     */
    public function numbersgetAvailabledoAsync($start = 0, $limit = 100)
    {
     ...
     */
    protected function numbersgetAvailabledoRequest($start = 0, $limit = 100)
    {
