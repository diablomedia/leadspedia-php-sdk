...
class ImpressionsApi
{
     ...
     */
    public function impressionsgetAllphpWithHttpInfo($startDate, $endDate = null, $start = 0, $limit = 100)
    {
     ...
     */
    protected function impressionsgetAllphpRequest($startDate, $endDate = null, $start = 0, $limit = 100)
    {
        // verify the required parameter 'startDate' is set
        if ($startDate === null || (is_array($startDate) && count($startDate) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $startDate when calling impressionsgetAllphp'
            );
        }
