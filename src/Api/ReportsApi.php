...
class ReportsApi
{
     ...
     */
    public function reportsgetAdvertisersReportdoRequest($fromDate, $advertiserAccountManagerID = null, $toDate = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function reportsgetAffiliatesReportdoRequest($fromDate, $affiliateAccountManagerID = null, $toDate = null)
    {
        // verify the required parameter 'fromDate' is set
        if ($fromDate === null || (is_array($fromDate) && count($fromDate) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function reportsgetCampaignsReportdoRequest($fromDate, $affiliateID = null, $verticalID = null, $toDate = null)
    {
        // verify the required parameter 'fromDate' is set
        if ($fromDate === null || (is_array($fromDate) && count($fromDate) === 0)) {
            throw new \InvalidArgumentException(
    ...
    /**
     * Operation reportsgetContractsReportdo
     *
     ...
     * @return \Leadspedia\Model\VerticalsgetAlldo200Response
     */
    public function reportsgetContractsReportdo($fromDate, $contractID = null, $advertiserID = null, $verticalID = null, $toDate = null)
    {
        list($response) = $this->reportsgetContractsReportdoWithHttpInfo($fromDate, $contractID, $advertiserID, $verticalID, $toDate);
        return $response;
    }

    /**
     * Operation reportsgetContractsReportdoWithHttpInfo
     *
     * Get Contracts Report
     *
     * @param  \DateTime $fromDate (required)
     ...
     * @return array of \Leadspedia\Model\VerticalsgetAlldo200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function reportsgetContractsReportdoWithHttpInfo($fromDate, $contractID = null, $advertiserID = null, $verticalID = null, $toDate = null)
    {
        $request = $this->reportsgetContractsReportdoRequest($fromDate, $contractID, $advertiserID, $verticalID, $toDate);
    ...
    /**
     * Operation reportsgetContractsReportdoAsync
     *
     * Get Contracts Report
     *
     * @param  \DateTime $fromDate (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportsgetContractsReportdoAsync($fromDate, $contractID = null, $advertiserID = null, $verticalID = null, $toDate = null)
    {
        return $this->reportsgetContractsReportdoAsyncWithHttpInfo($fromDate, $contractID, $advertiserID, $verticalID, $toDate)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation reportsgetContractsReportdoAsyncWithHttpInfo
     *
     * Get Contracts Report
     *
     * @param  \DateTime $fromDate (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportsgetContractsReportdoAsyncWithHttpInfo($fromDate, $contractID = null, $advertiserID = null, $verticalID = null, $toDate = null)
    {
        $returnType = '\Leadspedia\Model\VerticalsgetAlldo200Response';
        $request = $this->reportsgetContractsReportdoRequest($fromDate, $contractID, $advertiserID, $verticalID, $toDate);
    ...
    /**
     * Create request for operation 'reportsgetContractsReportdo'
     *
     * @param  \DateTime $fromDate (required)
     * @param  int $contractID (optional)
     * @param  int $advertiserID (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function reportsgetContractsReportdoRequest($fromDate, $contractID = null, $advertiserID = null, $verticalID = null, $toDate = null)
    {
        // verify the required parameter 'fromDate' is set
        if ($fromDate === null || (is_array($fromDate) && count($fromDate) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fromDate when calling reportsgetContractsReportdo'
            );
        }

        $resourcePath = '/reports/getContractsReport.do';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function reportsgetOffersReportdoRequest($fromDate, $verticalID = null, $toDate = null)
    {
        // verify the required parameter 'fromDate' is set
        if ($fromDate === null || (is_array($fromDate) && count($fromDate) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function reportsgetVerticalsReportdoRequest($fromDate, $toDate = null)
    {
        // verify the required parameter 'fromDate' is set
        if ($fromDate === null || (is_array($fromDate) && count($fromDate) === 0)) {
            throw new \InvalidArgumentException(
