...
class AdvertisersApi
{
    ...
    protected function advertiserscreatedoRequest($advertiserName, $accountManagerID, $status)
    {
        ...
        if (is_array($advertiserName)) {
            $advertiserName = ObjectSerializer::serializeCollection($advertiserName, '', true);
        }
        if ($advertiserName !== null) {
            $queryParams['advertiserName'] = $advertiserName;
        }
        // query params
    ...
    protected function advertisersgetAlldoRequest($advertiserID = null, $advertiserType = null, $accountManagerID = null, $status = null, $isCreditEnabled = null, $hasCreditCardOnFile = null, $search = null, $start = 0, $limit = 100)
    {
        ...
        // query params
        if (is_array($advertiserType)) {
            $advertiserType = ObjectSerializer::serializeCollection($advertiserType, '', true);
        }
        if ($advertiserType !== null) {
            $queryParams['advertiserType'] = $advertiserType;
        }
        // query params
        if (is_array($accountManagerID)) {
            $accountManagerID = ObjectSerializer::serializeCollection($accountManagerID, '', true);
        ...
        // query params
        if (is_array($isCreditEnabled)) {
            $isCreditEnabled = ObjectSerializer::serializeCollection($isCreditEnabled, '', true);
        }
        if ($isCreditEnabled !== null) {
            $queryParams['isCreditEnabled'] = $isCreditEnabled;
        }
        // query params
        if (is_array($hasCreditCardOnFile)) {
            $hasCreditCardOnFile = ObjectSerializer::serializeCollection($hasCreditCardOnFile, '', true);
        }
        if ($hasCreditCardOnFile !== null) {
            $queryParams['hasCreditCardOnFile'] = $hasCreditCardOnFile;
        }
        // query params
        if (is_array($search)) {
    ...
    protected function advertisersupdateAuthorizeNetCustomerProfileIDdoRequest($advertiserID, $authNetCustomerProfileID = null)
    {
        ...
        // query params
        if (is_array($authNetCustomerProfileID)) {
            $authNetCustomerProfileID = ObjectSerializer::serializeCollection($authNetCustomerProfileID, '', true);
        }
        if ($authNetCustomerProfileID !== null) {
            $queryParams['authNetCustomerProfileID'] = $authNetCustomerProfileID;
        }
    ...
    protected function advertisersupdateInfodoRequest($advertiserID, $advertiserName = null, $website = null, $alternateID = null, $source = null, $externalCRMID = null, $numberOfStaff = null, $address = null, $address2 = null, $city = null, $state = null, $zipCode = null, $country = null, $reportingUrl = null, $reportingUsername = null, $reportingPassword = null)
    {
        ...
        // query params
        if (is_array($externalCRMID)) {
            $externalCRMID = ObjectSerializer::serializeCollection($externalCRMID, '', true);
        }
        if ($externalCRMID !== null) {
            $queryParams['externalCRMID'] = $externalCRMID;
        }
        // query params
        if (is_array($numberOfStaff)) {
            $numberOfStaff = ObjectSerializer::serializeCollection($numberOfStaff, '', true);
        }
        if ($numberOfStaff !== null) {
            $queryParams['numberOfStaff'] = $numberOfStaff;
        }
        // query params
        if (is_array($address)) {
    ...
    protected function advertisersupdateLeadsCapsdoRequest($advertiserID, $leadsDailyCap = null, $leadsWeeklyCap = null, $leadsMonthlyCap = null)
    {
        ...
        // query params
        if (is_array($leadsDailyCap)) {
            $leadsDailyCap = ObjectSerializer::serializeCollection($leadsDailyCap, '', true);
        }
        if ($leadsDailyCap !== null) {
            $queryParams['leadsDailyCap'] = $leadsDailyCap;
        }
        // query params
        if (is_array($leadsWeeklyCap)) {
            $leadsWeeklyCap = ObjectSerializer::serializeCollection($leadsWeeklyCap, '', true);
        }
        if ($leadsWeeklyCap !== null) {
            $queryParams['leadsWeeklyCap'] = $leadsWeeklyCap;
        }
        // query params
        if (is_array($leadsMonthlyCap)) {
            $leadsMonthlyCap = ObjectSerializer::serializeCollection($leadsMonthlyCap, '', true);
        }
        if ($leadsMonthlyCap !== null) {
            $queryParams['leadsMonthlyCap'] = $leadsMonthlyCap;
        }
    ...
    protected function advertisersupdateLeadsDailyRevenueCapdoRequest($advertiserID, $leadsDailyRevenueCap = null)
    {
        ...
        // query params
        if (is_array($leadsDailyRevenueCap)) {
            $leadsDailyRevenueCap = ObjectSerializer::serializeCollection($leadsDailyRevenueCap, '', true);
        }
        if ($leadsDailyRevenueCap !== null) {
            $queryParams['leadsDailyRevenueCap'] = $leadsDailyRevenueCap;
        }
    ...
    protected function advertisersupdateLeadsMonthlyRevenueCapdoRequest($advertiserID, $leadsMonthlyRevenueCap = null)
    {
        ...
        // query params
        if (is_array($leadsMonthlyRevenueCap)) {
            $leadsMonthlyRevenueCap = ObjectSerializer::serializeCollection($leadsMonthlyRevenueCap, '', true);
        }
        if ($leadsMonthlyRevenueCap !== null) {
            $queryParams['leadsMonthlyRevenueCap'] = $leadsMonthlyRevenueCap;
        }
    ...
    protected function advertisersupdateLeadsRevenueCapsdoRequest($advertiserID, $leadsDailyRevenueCap = null, $leadsWeeklyRevenueCap = null, $leadsMonthlyRevenueCap = null)
    {
        ...
        // query params
        if (is_array($leadsWeeklyRevenueCap)) {
            $leadsWeeklyRevenueCap = ObjectSerializer::serializeCollection($leadsWeeklyRevenueCap, '', true);
        }
        if ($leadsWeeklyRevenueCap !== null) {
            $queryParams['leadsWeeklyRevenueCap'] = $leadsWeeklyRevenueCap;
        }
        // query params
        if (is_array($leadsMonthlyRevenueCap)) {
            $leadsMonthlyRevenueCap = ObjectSerializer::serializeCollection($leadsMonthlyRevenueCap, '', true);
    ...
    protected function advertisersupdatePortalSettingsdoRequest($portalAccess = null, $twoWayAuth = null, $manageUsers = null, $manageOffers = null, $updateBillingInfo = null)
    {
        ...
        // query params
        if (is_array($twoWayAuth)) {
            $twoWayAuth = ObjectSerializer::serializeCollection($twoWayAuth, '', true);
        }
        if ($twoWayAuth !== null) {
            $queryParams['two_way_auth'] = $twoWayAuth;
        }
        // query params
        if (is_array($manageUsers)) {
            $manageUsers = ObjectSerializer::serializeCollection($manageUsers, '', true);
        }
        if ($manageUsers !== null) {
            $queryParams['manage_users'] = $manageUsers;
        }
        // query params
        if (is_array($manageOffers)) {
            $manageOffers = ObjectSerializer::serializeCollection($manageOffers, '', true);
        }
        if ($manageOffers !== null) {
            $queryParams['manage_offers'] = $manageOffers;
        }
        // query params
        if (is_array($updateBillingInfo)) {
            $updateBillingInfo = ObjectSerializer::serializeCollection($updateBillingInfo, '', true);
        }
        if ($updateBillingInfo !== null) {
            $queryParams['update_billing_info'] = $updateBillingInfo;
        }
