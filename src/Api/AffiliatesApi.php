...
class AffiliatesApi
{
     ...
     */
    public function affiliateschangeStatusdoRequest($affiliateID, $status)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function affiliatescreatedoRequest($affiliateName, $accountManagerID, $status)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function affiliatesdeletedoRequest($affiliateID)
    {
        // verify the required parameter 'affiliateID' is set
        if ($affiliateID === null || (is_array($affiliateID) && count($affiliateID) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function affiliatesgetAlldoRequest($affiliateID = null, $accountManagerID = null, $status = null, $search = null, $start = 0, $limit = 100)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function affiliatesgetInfodoRequest($affiliateID)
    {
        // verify the required parameter 'affiliateID' is set
        if ($affiliateID === null || (is_array($affiliateID) && count($affiliateID) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function affiliatessearchdoRequest($search, $start = 0, $limit = 100)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function affiliatesupdateBillingdoRequest($affiliateID, $billingCycle = null, $taxID = null, $taxClass = null, $taxDocReceived = null)
    {
        // verify the required parameter 'affiliateID' is set
        if ($affiliateID === null || (is_array($affiliateID) && count($affiliateID) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $taxDocReceived,
            'tax_doc_received', // param base name
            'string', // openApiType
            '', // style
            false, // explode
            false // required
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function affiliatesupdateInfodoRequest($affiliateID, $affiliateName = null, $website = null, $alternateID = null, $address = null, $address2 = null, $city = null, $state = null, $zipCode = null, $country = null, $reportingUrl = null, $reportingUsername = null, $reportingPassword = null)
    {
        // verify the required parameter 'affiliateID' is set
        if ($affiliateID === null || (is_array($affiliateID) && count($affiliateID) === 0)) {
            throw new \InvalidArgumentException(
