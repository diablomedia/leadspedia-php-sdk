...
class AdvertisersCreditCardsApi
{
    ...
    protected function advertisersCreditCardsadddoRequest($advertiserID, $cardNumber, $nameOnCard, $expMonth, $expYear, $cvv, $address, $city, $state, $zipCode, $country, $address2 = null, $defaultCard = 'No')
    {
        ...
        if (is_array($cardNumber)) {
            $cardNumber = ObjectSerializer::serializeCollection($cardNumber, '', true);
        }
        if ($cardNumber !== null) {
        ...
        if (is_array($nameOnCard)) {
            $nameOnCard = ObjectSerializer::serializeCollection($nameOnCard, '', true);
        }
        if ($nameOnCard !== null) {
            $queryParams['nameOnCard'] = $nameOnCard;
        }
        // query params
        if (is_array($expMonth)) {
            $expMonth = ObjectSerializer::serializeCollection($expMonth, '', true);
        }
        if ($expMonth !== null) {
            $queryParams['expMonth'] = $expMonth;
        }
        // query params
        if (is_array($expYear)) {
            $expYear = ObjectSerializer::serializeCollection($expYear, '', true);
        }
        if ($expYear !== null) {
            $queryParams['expYear'] = $expYear;
        }
        // query params
        if (is_array($cvv)) {
            $cvv = ObjectSerializer::serializeCollection($cvv, '', true);
        }
        if ($cvv !== null) {
            $queryParams['cvv'] = $cvv;
        }
        ...
        if (is_array($defaultCard)) {
            $defaultCard = ObjectSerializer::serializeCollection($defaultCard, '', true);
        }
        if ($defaultCard !== null) {
            $queryParams['defaultCard'] = $defaultCard;
        }
    ...
    protected function advertisersCreditCardsdeletedoRequest($advertiserID, $creditCardID)
    {
        ...
        if (is_array($creditCardID)) {
            $creditCardID = ObjectSerializer::serializeCollection($creditCardID, '', true);
        }
        if ($creditCardID !== null) {
            $queryParams['creditCardID'] = $creditCardID;
        }
    ...
    protected function advertisersCreditCardsupdatePaymentProfileIDdoRequest($creditCardID, $advertiserID, $paymentProfileID = null, $expMonth = null, $expYear = null, $address = null, $address2 = null, $city = null, $state = null, $zipCode = null, $country = null)
    {
        ...
        // query params
        if (is_array($paymentProfileID)) {
            $paymentProfileID = ObjectSerializer::serializeCollection($paymentProfileID, '', true);
        }
        if ($paymentProfileID !== null) {
            $queryParams['paymentProfileID'] = $paymentProfileID;
        }
        // query params
        if (is_array($expMonth)) {
            $expMonth = ObjectSerializer::serializeCollection($expMonth, '', true);
