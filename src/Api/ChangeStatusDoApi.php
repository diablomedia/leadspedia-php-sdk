...
class ChangeStatusDoApi
{
     ...
     */
    public function changeStatusdo($verticalID, $status = null): void
    {
        $this->changeStatusdoWithHttpInfo($verticalID, $status);
    }
     ...
     */
    public function changeStatusdoWithHttpInfo($verticalID, $status = null)
    {
     ...
     */
    protected function changeStatusdoRequest($verticalID, $status = null)
    {
        // verify the required parameter 'verticalID' is set
        if ($verticalID === null || (is_array($verticalID) && count($verticalID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $verticalID when calling changeStatusdo'
            );
        }
